    ...
    return (
      <Router>
        <div>
          ...
          <Route path='/patient-login' render={ (props) => <LoginForm url="http://localhost:3000/api/v1/patient_sessions" onSuccess={this.patientAuthSuccess} {...props} type='Patient' /> } />
          <Route path='/provider-login' render={ (props) => <LoginForm url="http://localhost:3000/api/v1/doctor_sessions" onSuccess={this.patientAuthSuccess} {...props} type='Provider' /> } />
